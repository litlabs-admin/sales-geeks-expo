...
This file gives future Claude sessions the context needed to be useful on this project from the first message.
...
The user has the question list. When they bring back answers, capture decisions back into `northstar.md` (and update this CLAUDE.md if anything foundational changes).
